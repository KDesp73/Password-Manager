...
public class SQLMethods {
        ...
        public static ArrayList<String[]> SELECT(Statement s, String Table, String[] Cols) throws SQLException {
                ArrayList<String[]> list = new ArrayList<>();

                String query = "SELECT " + Utils.arrayToList(Cols) + " FROM " + Table;
                ResultSet rs = s.executeQuery(query);
        ...
        public static ArrayList<String[]> SELECT(Statement s, String Table, String[] Cols, String Col, String Value) throws SQLException {
                ArrayList<String[]> list = new ArrayList<>();

                String query = "SELECT " + Utils.arrayToList(Cols) + " FROM " + Table+ " WHERE " + Col + " = \"" +Value + "\"";
                ResultSet rs = s.executeQuery(query);
